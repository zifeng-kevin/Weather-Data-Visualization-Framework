 ...
 */
public class SelectOneInputEntry extends InputEntry {
   ...
   */
  public SelectOneInputEntry(String label, String helpMessage) {
  ...
  public InputEntryType getEntryType() {
    return InputEntryType.SELECT_ONE_INPUT_ENTRY;
  }
