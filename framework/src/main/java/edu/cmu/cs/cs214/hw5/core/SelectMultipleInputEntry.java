 ...
 */
public class SelectMultipleInputEntry extends InputEntry {
   ...
   */
  public SelectMultipleInputEntry(String label, String helpMessage) {
  ...
  public InputEntryType getEntryType() {
    return InputEntryType.SELECT_MULTIPLE_INPUT_ENTRY;
  }
